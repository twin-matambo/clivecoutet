  ...
  const projects = [
    {
      ...
      category: "Branding",
      tagline: "Redefining wellness with bold new visual identity",
      color: "bg-gradient-to-br from-[#E31853] to-[#EF5B5A]",
    },
    {
      name: "Verde Coffee Co.",
      category: "Social Media",
      tagline: "Building a community of coffee lovers online",
      color: "bg-gradient-to-br from-[#F48C60] to-[#FFC25F]",
    },
    {
      name: "Nexus Tech",
      category: "Promotional Video",
      tagline: "Launch campaign that hit 2M+ views in week one",
      color: "bg-gradient-to-br from-[#EF5B5A] to-[#F48C60]",
    },
    {
      name: "Studio Noire",
      category: "Podcast",
      tagline: "From concept to top 50 in first month",
      color: "bg-gradient-to-br from-[#E31853] to-[#FFC25F]",
    },
    {
      name: "Meridian Hotels",
      category: "Content Creation",
      tagline: "Visual content strategy across 12 properties",
      color: "bg-gradient-to-br from-[#F48C60] to-[#FFC25F]",
    },
    {
      name: "Pulse Athletics",
      category: "Paid Social",
      tagline: "3.2x ROAS on Meta and TikTok campaigns",
      color: "bg-gradient-to-br from-[#E31853] to-[#EF5B5A]",
    },
  ];
